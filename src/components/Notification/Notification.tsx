...
export default function Notification({ variant, ...props }: Props) {
  ...
  return (
    ...
    >
      <div
        ...
        style={{
          backgroundColor:
            variant === 'rounded' && theme.palette[props.color] && tinycolor(theme.palette[props.color].main).setAlpha(0.15).toRgbString(),
        }}
      >
        {iconWithStyles}
      </div>
